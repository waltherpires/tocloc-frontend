  ...
  return (
    <div className="flex justify-center items-center h-[90vh]"> 
      <div className="w-1/3 p-6 shadow-lg bg-white rounded-md"> 
        ...
        <hr className="mt-3"/>      
        <div className="mt-3">
          <label for="username" className="block text-base mb-2">Nome</label>
        ...
        <div className="mt-3">
          <label for="password" className="block text-base mb-2">Nova Senha</label>
        ...
        <div className="mt-3">
          <label for="email" className="block text-base mb-2">E-mail</label>
        ...
        <div className="mt-3">
          <label for="tipo" className="block text-base mb-2">Tipo de Usuário</label>
